...
public class SkeletonMinion implements Listener {

    public SkeletonMinion (Main main) {
    ...
    public void SpawnListener(CreatureSpawnEvent e) {
        ...
        if (random < 35) {
            if (e.getEntity() instanceof Skeleton) {
                ...
                //Armor
                z.setCustomName(ChatColor.GOLD + "" + ChatColor.BOLD + "Hunter Skeleton");
                ...
                bw.addEnchantment(Enchantment.ARROW_DAMAGE, 5);
                bw.addEnchantment(Enchantment.ARROW_FIRE, 1);
