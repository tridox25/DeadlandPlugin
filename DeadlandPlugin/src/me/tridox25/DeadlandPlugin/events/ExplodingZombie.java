...
public class ExplodingZombie implements Listener {


    private Main plugin;

    public ExplodingZombie (Main main) {
        this.plugin = main;
    }
    ...
    public void SpawnListener(CreatureSpawnEvent e) {
        ...
        if (random < 25) {
            ...
            if (e.getEntity() instanceof Zombie) {
                ...
                z.setCustomName(ChatColor.RED + "" + ChatColor.BOLD + "Explosion Zombi");
    ...
    public void OnDamageEntity (EntityDamageByEntityEvent e) {
        ...
        if (e.getDamager() instanceof Arrow) {
            ...
            if (arrow.getShooter() instanceof Player && e.getDamager() instanceof Zombie) {
                if (e.getEntity().hasMetadata("ZombieExplosivo")) {
